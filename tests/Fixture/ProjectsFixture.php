...
class ProjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'launch' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'projects_ibfk_2' => ['type' => 'foreign', 'columns' => ['client_id'], 'references' => ['clients', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'projects_ibfk_3' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'launch' => '2016-01-14 12:16:32',
            'created' => '2016-01-14 12:16:32',
            'modified' => '2016-01-14 12:16:32'
        ],
    ];
}
